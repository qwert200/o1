...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/source_hamody) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/source_hamody) /haamody \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/source_hamody)\n [ 𓏺 ََِ𝗦𝗢𝗨𝗥𝗖𝗘 𝗛𝗔𝗠𝗢𝗗𝗬‌↺ ](https://t.me/source_hamody)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/source_hamody) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/q_r_II"),
                
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="haamody"),
                ],
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/source_hamody) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/source_hamody) \n ※[These Features AI Based](https://t.me/source_hamody)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="source_hamody"),
                ],
                [                
                ...
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/MH_BP"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("source_hamody"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f""" **※Welcome \n
※Show members keyboard Send /hamody \n\n
※Show entertainment keyboard send /haamody**
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="english")]]
        ),
...
√ __Powered by 𓏺 ََِ𝗦𝗢𝗨𝗥𝗖𝗘 𝗛𝗔𝗠𝗢𝗗𝗬‌↺  """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل من هنا : @source_hamody **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
...
@Client.on_callback_query(filters.regex("haamody"))
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""※ مرحبا بك \n ※ لتفعيل كيبورد الاعضاء ارسل /hamody \n ※ لتفعيل كيبورد التسليه ارسل /haamody""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
