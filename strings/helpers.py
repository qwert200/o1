HELP_1 = """<b><u>اوامر الادمن:</b></u>

/pause : ايقاف التشغيل الحالي مؤقتاً.

/resume : استئناف التشغيل الحالي.

/skip : تخطي التشغيل الحالي الى التشغيل التالي.

/end ᴏʀ /stop : ايقاف او انهاء التشغيل في المكالمة الصوتيه.

/player : الحصول على قائمة التشغيل الحالي.

/queue : الحصول على قائكة التشغيل التالي.
"""

HELP_2 = """
<b><u>اضافة المستخدمين :</b></u>

/auth [اليوزر/الايدي] : لاضافة عضو الى البوت.
/unauth [اليوزر/الايدي] : لازالة عضو من اليوت.
/authusers : لعرض قائمة الاعضاء في البوت.
"""
